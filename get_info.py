...
def get_streamer_dict(db, streamer):
    ...
    streamer_dict['viewers'] = [field[1] for field in data]  # viewers
    streamer_dict['followers'] = [field[2] for field in data]  # followers
...
def main():
    ...
    for streamer in tqdm(table_names):
        if streamer in streamers_to_ignore:
            ...
            continue
        # get the db data from the table of the same name as the streamer
